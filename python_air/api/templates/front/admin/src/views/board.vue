		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="kongqizhiliangChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="kongqizhiliangChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>空气质量总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{kongqizhiliangCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>空气质量</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="positionname" label="站点"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="aqi" label="AQI"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pm25" label="PM2_5"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pm10" label="PM10"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="so2" label="SO2"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="no2" label="NO2"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="co" label="CO"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="o3" label="O3"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="kongqizhiliangChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="kongqizhiliangChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="kongqizhiliangChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			...
			this.kongqizhiliangChat1();
			this.kongqizhiliangChat2();
			this.kongqizhiliangChat3();
			this.kongqizhiliangChat4();
			this.kongqizhiliangChat5();
		},500)
	})
  },
  methods:{
...
//统计接口1
    kongqizhiliangChat1() {
      this.$nextTick(()=>{
        ...
        var kongqizhiliangChart1 = echarts.init(document.getElementById("kongqizhiliangChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kongqizhiliangChart1.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    kongqizhiliangChart1.resize();
                },false);
            }
        });
      })
...
//统计接口2
    kongqizhiliangChat2() {
      this.$nextTick(()=>{
        ...
        var kongqizhiliangChart2 = echarts.init(document.getElementById("kongqizhiliangChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kongqizhiliangChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    kongqizhiliangChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    kongqizhiliangChat3() {
      this.$nextTick(()=>{
        ...
        var kongqizhiliangChart3 = echarts.init(document.getElementById("kongqizhiliangChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kongqizhiliangChart3.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, kongqizhiliangChart3)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    kongqizhiliangChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    kongqizhiliangChat4() {
      this.$nextTick(()=>{
        ...
        var kongqizhiliangChart4 = echarts.init(document.getElementById("kongqizhiliangChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kongqizhiliangChart4.setOption(option);
				
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, kongqizhiliangChart4)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    kongqizhiliangChart4.resize();
				},false);
            }
        });
      })
...
//统计接口5
    kongqizhiliangChat5() {
      this.$nextTick(()=>{
        ...
        var kongqizhiliangChart5 = echarts.init(document.getElementById("kongqizhiliangChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                kongqizhiliangChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    kongqizhiliangChart5.resize();
					},false);
            }
        });
      })
