...
<div :style='{"minHeight":"500px","padding":"20px 20px 40px","margin":"0px auto","borderColor":"#ddd","background":"#fff","borderWidth":"0px","width":"1200px","position":"relative","borderStyle":"solid"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="用户操作" prop="operation">
            <el-input v-model="ruleForm.operation" 
                placeholder="用户操作" clearable :disabled=" false  ||ro.operation"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="请求方法" prop="method">
            <el-input v-model="ruleForm.method" 
                placeholder="请求方法" clearable :disabled=" false  ||ro.method"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="请求时长(毫秒)" prop="time">
            <el-input v-model="ruleForm.time" 
                placeholder="请求时长(毫秒)" clearable :disabled=" false  ||ro.time"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="IP地址" prop="ip">
            <el-input v-model="ruleForm.ip" 
                placeholder="IP地址" clearable :disabled=" false  ||ro.ip"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="请求参数" prop="params">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="请求参数"
