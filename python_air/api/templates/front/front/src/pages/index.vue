	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px calc((100% - 1200px)/2)","borderColor":"#C20C0C","alignItems":"center","color":"rgb(204, 204, 204)","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#3a3a3a","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"36px","position":"fixed","borderStyle":"solid","height":"36px","zIndex":"1002"}'>
			...
			<div :style='{"padding":"0","margin":"0","left":"calc((100% - 1200px)/2)","background":"none","display":"inline-block","width":"auto","position":"absolute","float":"left","height":"100%"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"16px","float":"left","fontWeight":"500","height":"100%"}'>基于Python的空气质量综合分析系统的设计与实现</span>
			</div>
			<!-- time -->
			<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"24px","color":"inherit"}'>{{times}}</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除","AQI分析","PM2-5分析","PM10分析","SO2分析","O3分析","导出","导入","上传模板","下载模板","首页总数","爬取数据"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除","导出","导入","爬取数据"],"menu":"空气质量","menuJump":"列表","tableName":"kongqizhiliang"}],"menu":"空气质量管理"},{"child":[{"allButtons":["查看","删除"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看","删除"],"menu":"系统日志","tableName":"syslog"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-present","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-discover","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","AQI分析","PM2-5分析","PM10分析","SO2分析","O3分析","导出","导入","上传模板","下载模板","首页总数","爬取数据"],"appFrontIcon":"cuIcon-time","buttons":["查看"],"menu":"空气质量","menuJump":"列表","tableName":"kongqizhiliang"}],"menu":"空气质量模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","AQI分析","PM2-5分析","PM10分析","SO2分析","O3分析","导出","导入","上传模板","下载模板","首页总数","爬取数据"],"appFrontIcon":"cuIcon-time","buttons":["查看"],"menu":"空气质量","menuJump":"列表","tableName":"kongqizhiliang"}],"menu":"空气质量模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
