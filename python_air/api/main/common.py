...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python0745x1xa/examusers/login" ,
            "/python0745x1xa/examusers/register",
            '/python0745x1xa/defaultuser/login',
            '/python0745x1xa/users/login',
        ...
        post_list = [
            '/python0745x1xa/defaultuser/register',
            '/python0745x1xa/defaultuser/login',
            '/python0745x1xa/users/register',
            '/python0745x1xa/users/login',
            "/python0745x1xa/examusers/login" ,
            "/python0745x1xa/examusers/register"
        ]  # 免认证list
