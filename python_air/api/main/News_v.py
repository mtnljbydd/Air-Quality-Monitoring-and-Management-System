...
# 注册接口
@main_bp.route("/python0745x1xa/news/register", methods=['POST'])
def python0745x1xa_news_register():
...
# 登录接口
@main_bp.route("/python0745x1xa/news/login", methods=['GET','POST'])
def python0745x1xa_news_login():
...
# 登出接口
@main_bp.route("/python0745x1xa/news/logout", methods=['POST'])
def python0745x1xa_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python0745x1xa/news/resetPass", methods=['POST'])
def python0745x1xa_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python0745x1xa/news/session", methods=['GET'])
def python0745x1xa_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python0745x1xa/news/page", methods=['GET'])
def python0745x1xa_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python0745x1xa/news/autoSort", methods=['GET'])
def python0745x1xa_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/python0745x1xa/news/query", methods=['GET'])
def python0745x1xa_news_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python0745x1xa/news/list", methods=['GET'])
def python0745x1xa_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python0745x1xa/news/save", methods=['POST'])
def python0745x1xa_news_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/python0745x1xa/news/add", methods=['POST'])
def python0745x1xa_news_add():
    '''
    '''
    request.operation = "新增通知公告"
    if request.method == 'POST':
...
# 踩、赞接口
@main_bp.route("/python0745x1xa/news/thumbsup/<id_>", methods=['GET'])
def python0745x1xa_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python0745x1xa/news/info/<id_>", methods=['GET'])
def python0745x1xa_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python0745x1xa/news/detail/<id_>", methods=['GET'])
def python0745x1xa_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python0745x1xa/news/update", methods=['POST'])
def python0745x1xa_news_update():
    '''
    '''
...
# 删除接口
@main_bp.route("/python0745x1xa/news/delete", methods=['POST'])
def python0745x1xa_news_delete():
    '''
    '''
...
# 投票接口
@main_bp.route("/python0745x1xa/news/vote/<int:id_>", methods=['POST'])
def python0745x1xa_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python0745x1xa/news/group/<columnName>", methods=['GET'])
def python0745x1xa_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        app.executor.submit(spark_read_mysql, f"({sql}) "+'news', json_filename)
...
# 按值统计接口
@main_bp.route("/python0745x1xa/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python0745x1xa_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python0745x1xa/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python0745x1xa_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python0745x1xa/news/valueMul/<xColumnName>", methods=['GET'])
def python0745x1xa_news_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python0745x1xa/news/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python0745x1xa_news_valueMul_time(xColumnName,timeStatType):
...
# 推荐算法接口
@main_bp.route("/python0745x1xa/news/autoSort2", methods=['GET'])
def python0745x1xa_news_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python0745x1xa/news/remind/<columnName>/<type>", methods=['GET'])  #
def python0745x1xa_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python0745x1xa/news/lists", methods=['GET'])
def python0745x1xa_news_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
