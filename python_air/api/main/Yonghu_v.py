...
# 注册接口
@main_bp.route("/python0745x1xa/yonghu/register", methods=['POST'])
def python0745x1xa_yonghu_register():
...
# 登录接口
@main_bp.route("/python0745x1xa/yonghu/login", methods=['GET','POST'])
def python0745x1xa_yonghu_login():
...
# 登出接口
@main_bp.route("/python0745x1xa/yonghu/logout", methods=['POST'])
def python0745x1xa_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python0745x1xa/yonghu/resetPass", methods=['POST'])
def python0745x1xa_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python0745x1xa/yonghu/session", methods=['GET'])
def python0745x1xa_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python0745x1xa/yonghu/page", methods=['GET'])
def python0745x1xa_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python0745x1xa/yonghu/autoSort", methods=['GET'])
def python0745x1xa_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/python0745x1xa/yonghu/query", methods=['GET'])
def python0745x1xa_yonghu_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python0745x1xa/yonghu/list", methods=['GET'])
def python0745x1xa_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python0745x1xa/yonghu/save", methods=['POST'])
def python0745x1xa_yonghu_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/python0745x1xa/yonghu/add", methods=['POST'])
def python0745x1xa_yonghu_add():
    '''
    '''
    request.operation = "新增用户"
    if request.method == 'POST':
...
# 踩、赞接口
@main_bp.route("/python0745x1xa/yonghu/thumbsup/<id_>", methods=['GET'])
def python0745x1xa_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python0745x1xa/yonghu/info/<id_>", methods=['GET'])
def python0745x1xa_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python0745x1xa/yonghu/detail/<id_>", methods=['GET'])
def python0745x1xa_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python0745x1xa/yonghu/update", methods=['POST'])
def python0745x1xa_yonghu_update():
    '''
    '''
...
# 删除接口
@main_bp.route("/python0745x1xa/yonghu/delete", methods=['POST'])
def python0745x1xa_yonghu_delete():
    '''
    '''
...
# 投票接口
@main_bp.route("/python0745x1xa/yonghu/vote/<int:id_>", methods=['POST'])
def python0745x1xa_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python0745x1xa/yonghu/group/<columnName>", methods=['GET'])
def python0745x1xa_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python0745x1xa/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python0745x1xa_yonghu_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python0745x1xa/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python0745x1xa_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python0745x1xa/yonghu/valueMul/<xColumnName>", methods=['GET'])
def python0745x1xa_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python0745x1xa/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python0745x1xa_yonghu_valueMul_time(xColumnName,timeStatType):
...
# 统计接口
@main_bp.route("/python0745x1xa/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def python0745x1xa_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python0745x1xa/yonghu/lists", methods=['GET'])
def python0745x1xa_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
